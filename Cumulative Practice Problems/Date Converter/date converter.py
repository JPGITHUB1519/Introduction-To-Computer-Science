...
def date_converter(dic,date):
	...
	converted_date = converted_date + date[first + 1:second]
	converted_date = converted_date  + " "  + dic[int(date[:first])]
	converted_date = converted_date + " " + date[second + 1:]
...
print date_converter(swedish,"3/5/1938")
