...
angular.module("ui.bootstrap",["ui.bootstrap.tpls","ui.bootstrap.pagination","ui.bootstrap.typeahead","ui.bootstrap.position"]),angular.module("ui.bootstrap.tpls",["template/pagination/pager.html","template/pagination/pagination.html","template/typeahead/typeahead-match.html","template/typeahead/typeahead-popup.html"]),angular.module("ui.bootstrap.pagination",[]).controller("UibPaginationController",["$scope","$attrs","$parse",function(e,t,a){var n=this,i={$setViewValue:angular.noop},r=t.numPages?a(t.numPages).assign:angular.noop;this.init=function(o,l){i=o,this.config=l,i.$render=function(){n.render()},t.itemsPerPage?e.$parent.$watch(a(t.itemsPerPage),function(t){n.itemsPerPage=parseInt(t,10),e.totalPages=n.calculateTotalPages()}):this.itemsPerPage=l.itemsPerPage,e.$watch("totalItems",function(){e.totalPages=n.calculateTotalPages()}),e.$watch("totalPages",function(t){r(e.$parent,t),e.page>t?e.selectPage(t):i.$render()})},this.calculateTotalPages=function(){var t=this.itemsPerPage<1?1:Math.ceil(e.totalItems/this.itemsPerPage);return Math.max(t||0,1)},this.render=function(){e.page=parseInt(i.$viewValue,10)||1},e.selectPage=function(t,a){a&&a.preventDefault();var n=!e.ngDisabled||!a;n&&e.page!==t&&t>0&&t<=e.totalPages&&(a&&a.target&&a.target.blur(),i.$setViewValue(t),i.$render())},e.getText=function(t){return e[t+"Text"]||n.config[t+"Text"]},e.noPrevious=function(){return 1===e.page},e.noNext=function(){return e.page===e.totalPages}}]).constant("uibPaginationConfig",{itemsPerPage:10,boundaryLinks:!1,directionLinks:!0,firstText:"First",previousText:"Previous",nextText:"Next",lastText:"Last",rotate:!0}).directive("uibPagination",["$parse","uibPaginationConfig",function(e,t){return{restrict:"EA",scope:{totalItems:"=",firstText:"@",previousText:"@",nextText:"@",lastText:"@",ngDisabled:"="},require:["uibPagination","?ngModel"],controller:"UibPaginationController",controllerAs:"pagination",templateUrl:function(e,t){return t.templateUrl||"template/pagination/pagination.html"},replace:!0,link:function(a,n,i,r){function o(e,t,a){return{number:e,text:t,active:a}}function l(e,t){var a=[],n=1,i=t,r=angular.isDefined(c)&&t>c;r&&(u?(n=Math.max(e-Math.floor(c/2),1),i=n+c-1,i>t&&(i=t,n=i-c+1)):(n=(Math.ceil(e/c)-1)*c+1,i=Math.min(n+c-1,t)));for(var l=n;i>=l;l++){var s=o(l,l,l===e);a.push(s)}if(r&&!u){if(n>1){var p=o(n-1,"...",!1);a.unshift(p)}if(t>i){var d=o(i+1,"...",!1);a.push(d)}}return a}var s=r[0],p=r[1];if(p){var c=angular.isDefined(i.maxSize)?a.$parent.$eval(i.maxSize):t.maxSize,u=angular.isDefined(i.rotate)?a.$parent.$eval(i.rotate):t.rotate;a.boundaryLinks=angular.isDefined(i.boundaryLinks)?a.$parent.$eval(i.boundaryLinks):t.boundaryLinks,a.directionLinks=angular.isDefined(i.directionLinks)?a.$parent.$eval(i.directionLinks):t.directionLinks,s.init(p,t),i.maxSize&&a.$parent.$watch(e(i.maxSize),function(e){c=parseInt(e,10),s.render()});var d=s.render;s.render=function(){d(),a.page>0&&a.page<=a.totalPages&&(a.pages=l(a.page,a.totalPages))}}}}}]).constant("uibPagerConfig",{itemsPerPage:10,previousText:"« Previous",nextText:"Next »",align:!0}).directive("uibPager",["uibPagerConfig",function(e){return{restrict:"EA",scope:{totalItems:"=",previousText:"@",nextText:"@",ngDisabled:"="},require:["uibPager","?ngModel"],controller:"UibPaginationController",controllerAs:"pagination",templateUrl:function(e,t){return t.templateUrl||"template/pagination/pager.html"},replace:!0,link:function(t,a,n,i){var r=i[0],o=i[1];o&&(t.align=angular.isDefined(n.align)?t.$parent.$eval(n.align):e.align,r.init(o,e))}}}]),angular.module("ui.bootstrap.pagination").value("$paginationSuppressWarning",!1).controller("PaginationController",["$scope","$attrs","$parse","$log","$paginationSuppressWarning",function(e,t,a,n,i){i||n.warn("PaginationController is now deprecated. Use UibPaginationController instead.");var r=this,o={$setViewValue:angular.noop},l=t.numPages?a(t.numPages).assign:angular.noop;this.init=function(n,i){o=n,this.config=i,o.$render=function(){r.render()},t.itemsPerPage?e.$parent.$watch(a(t.itemsPerPage),function(t){r.itemsPerPage=parseInt(t,10),e.totalPages=r.calculateTotalPages()}):this.itemsPerPage=i.itemsPerPage,e.$watch("totalItems",function(){e.totalPages=r.calculateTotalPages()}),e.$watch("totalPages",function(t){l(e.$parent,t),e.page>t?e.selectPage(t):o.$render()})},this.calculateTotalPages=function(){var t=this.itemsPerPage<1?1:Math.ceil(e.totalItems/this.itemsPerPage);return Math.max(t||0,1)},this.render=function(){e.page=parseInt(o.$viewValue,10)||1},e.selectPage=function(t,a){a&&a.preventDefault();var n=!e.ngDisabled||!a;n&&e.page!==t&&t>0&&t<=e.totalPages&&(a&&a.target&&a.target.blur(),o.$setViewValue(t),o.$render())},e.getText=function(t){return e[t+"Text"]||r.config[t+"Text"]},e.noPrevious=function(){return 1===e.page},e.noNext=function(){return e.page===e.totalPages}}]).directive("pagination",["$parse","uibPaginationConfig","$log","$paginationSuppressWarning",function(e,t,a,n){return{restrict:"EA",scope:{totalItems:"=",firstText:"@",previousText:"@",nextText:"@",lastText:"@",ngDisabled:"="},require:["pagination","?ngModel"],controller:"PaginationController",controllerAs:"pagination",templateUrl:function(e,t){return t.templateUrl||"template/pagination/pagination.html"},replace:!0,link:function(i,r,o,l){function s(e,t,a){return{number:e,text:t,active:a}}function p(e,t){var a=[],n=1,i=t,r=angular.isDefined(d)&&t>d;r&&(g?(n=Math.max(e-Math.floor(d/2),1),i=n+d-1,i>t&&(i=t,n=i-d+1)):(n=(Math.ceil(e/d)-1)*d+1,i=Math.min(n+d-1,t)));for(var o=n;i>=o;o++){var l=s(o,o,o===e);a.push(l)}if(r&&!g){if(n>1){var p=s(n-1,"...",!1);a.unshift(p)}if(t>i){var c=s(i+1,"...",!1);a.push(c)}}return a}n||a.warn("pagination is now deprecated. Use uib-pagination instead.");var c=l[0],u=l[1];if(u){var d=angular.isDefined(o.maxSize)?i.$parent.$eval(o.maxSize):t.maxSize,g=angular.isDefined(o.rotate)?i.$parent.$eval(o.rotate):t.rotate;i.boundaryLinks=angular.isDefined(o.boundaryLinks)?i.$parent.$eval(o.boundaryLinks):t.boundaryLinks,i.directionLinks=angular.isDefined(o.directionLinks)?i.$parent.$eval(o.directionLinks):t.directionLinks,c.init(u,t),o.maxSize&&i.$parent.$watch(e(o.maxSize),function(e){d=parseInt(e,10),c.render()});var h=c.render;c.render=function(){h(),i.page>0&&i.page<=i.totalPages&&(i.pages=p(i.page,i.totalPages))}}}}}]).directive("pager",["uibPagerConfig","$log","$paginationSuppressWarning",function(e,t,a){return{restrict:"EA",scope:{totalItems:"=",previousText:"@",nextText:"@",ngDisabled:"="},require:["pager","?ngModel"],controller:"PaginationController",controllerAs:"pagination",templateUrl:function(e,t){return t.templateUrl||"template/pagination/pager.html"},replace:!0,link:function(n,i,r,o){a||t.warn("pager is now deprecated. Use uib-pager instead.");var l=o[0],s=o[1];s&&(n.align=angular.isDefined(r.align)?n.$parent.$eval(r.align):e.align,l.init(s,e))}}}]),angular.module("ui.bootstrap.typeahead",["ui.bootstrap.position"]).factory("uibTypeaheadParser",["$parse",function(e){var t=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w\d]*))\s+in\s+([\s\S]+?)$/;return{parse:function(a){var n=a.match(t);if(!n)throw new Error('Expected typeahead specification in form of "_modelValue_ (as _label_)? for _item_ in _collection_" but got "'+a+'".');return{itemName:n[3],source:e(n[4]),viewMapper:e(n[2]||n[1]),modelMapper:e(n[1])}}}}]).controller("UibTypeaheadController",["$scope","$element","$attrs","$compile","$parse","$q","$timeout","$document","$window","$rootScope","$uibPosition","uibTypeaheadParser",function(e,t,a,n,i,r,o,l,s,p,c,u){function d(){E.moveInProgress||(E.moveInProgress=!0,E.$digest()),R&&o.cancel(R),R=o(function(){E.matches.length&&g(),E.moveInProgress=!1},$)}function g(){E.position=S?c.offset(t):c.position(t),E.position.top+=t.prop("offsetHeight")}var h,f,m=[9,13,27,38,40],$=200,v=e.$eval(a.typeaheadMinLength);v||0===v||(v=1);var y,b,P=e.$eval(a.typeaheadWaitMs)||0,x=e.$eval(a.typeaheadEditable)!==!1,w=i(a.typeaheadLoading).assign||angular.noop,T=i(a.typeaheadOnSelect),I=angular.isDefined(a.typeaheadSelectOnBlur)?e.$eval(a.typeaheadSelectOnBlur):!1,M=i(a.typeaheadNoResults).assign||angular.noop,U=a.typeaheadInputFormatter?i(a.typeaheadInputFormatter):void 0,S=a.typeaheadAppendToBody?e.$eval(a.typeaheadAppendToBody):!1,k=a.typeaheadAppendToElementId||!1,D=e.$eval(a.typeaheadFocusFirst)!==!1,L=a.typeaheadSelectOnExact?e.$eval(a.typeaheadSelectOnExact):!1,C=i(a.ngModel),V=i(a.ngModel+"($$$p)"),A=function(t,a){return angular.isFunction(C(e))&&f&&f.$options&&f.$options.getterSetter?V(t,{$$$p:a}):C.assign(t,a)},q=u.parse(a.uibTypeahead),E=e.$new(),O=e.$on("$destroy",function(){E.$destroy()});E.$on("$destroy",O);var W="typeahead-"+E.$id+"-"+Math.floor(1e4*Math.random());t.attr({"aria-autocomplete":"list","aria-expanded":!1,"aria-owns":W});var z=angular.element("<div uib-typeahead-popup></div>");z.attr({id:W,matches:"matches",active:"activeIdx",select:"select(activeIdx)","move-in-progress":"moveInProgress",query:"query",position:"position"}),angular.isDefined(a.typeaheadTemplateUrl)&&z.attr("template-url",a.typeaheadTemplateUrl),angular.isDefined(a.typeaheadPopupTemplateUrl)&&z.attr("popup-template-url",a.typeaheadPopupTemplateUrl);var N=function(){E.matches=[],E.activeIdx=-1,t.attr("aria-expanded",!1)},F=function(e){return W+"-option-"+e};E.$watch("activeIdx",function(e){0>e?t.removeAttr("aria-activedescendant"):t.attr("aria-activedescendant",F(e))});var B=function(e,t){return E.matches.length>t&&e?e.toUpperCase()===E.matches[t].label.toUpperCase():!1},H=function(a){var n={$viewValue:a};w(e,!0),M(e,!1),r.when(q.source(e,n)).then(function(i){var r=a===h.$viewValue;if(r&&y)if(i&&i.length>0){E.activeIdx=D?0:-1,M(e,!1),E.matches.length=0;for(var o=0;o<i.length;o++)n[q.itemName]=i[o],E.matches.push({id:F(o),label:q.viewMapper(E,n),model:i[o]});E.query=a,g(),t.attr("aria-expanded",!0),L&&1===E.matches.length&&B(a,0)&&E.select(0)}else N(),M(e,!0);r&&w(e,!1)},function(){N(),w(e,!1),M(e,!0)})};S&&(angular.element(s).bind("resize",d),l.find("body").bind("scroll",d));var R;E.moveInProgress=!1,E.query=void 0;var _,j=function(e){_=o(function(){H(e)},P)},X=function(){_&&o.cancel(_)};N(),E.select=function(n){var i,r,l={};b=!0,l[q.itemName]=r=E.matches[n].model,i=q.modelMapper(e,l),A(e,i),h.$setValidity("editable",!0),h.$setValidity("parse",!0),T(e,{$item:r,$model:i,$label:q.viewMapper(e,l)}),N(),E.$eval(a.typeaheadFocusOnSelect)!==!1&&o(function(){t[0].focus()},0,!1)},t.bind("keydown",function(e){if(0!==E.matches.length&&-1!==m.indexOf(e.which)){if(-1===E.activeIdx&&(9===e.which||13===e.which))return N(),void E.$digest();e.preventDefault(),40===e.which?(E.activeIdx=(E.activeIdx+1)%E.matches.length,E.$digest()):38===e.which?(E.activeIdx=(E.activeIdx>0?E.activeIdx:E.matches.length)-1,E.$digest()):13===e.which||9===e.which?E.$apply(function(){E.select(E.activeIdx)}):27===e.which&&(e.stopPropagation(),N(),E.$digest())}}),t.bind("blur",function(){I&&E.matches.length&&-1!==E.activeIdx&&!b&&(b=!0,E.$apply(function(){E.select(E.activeIdx)})),y=!1,b=!1});var Y=function(e){t[0]!==e.target&&3!==e.which&&0!==E.matches.length&&(N(),p.$$phase||E.$digest())};l.bind("click",Y),e.$on("$destroy",function(){l.unbind("click",Y),(S||k)&&G.remove(),S&&(angular.element(s).unbind("resize",d),l.find("body").unbind("scroll",d)),z.remove()});var G=n(z)(E);S?l.find("body").append(G):k!==!1?angular.element(l[0].getElementById(k)).append(G):t.after(G),this.init=function(t,a){h=t,f=a,h.$parsers.unshift(function(t){return y=!0,0===v||t&&t.length>=v?P>0?(X(),j(t)):H(t):(w(e,!1),X(),N()),x?t:t?void h.$setValidity("editable",!1):(h.$setValidity("editable",!0),null)}),h.$formatters.push(function(t){var a,n,i={};return x||h.$setValidity("editable",!0),U?(i.$model=t,U(e,i)):(i[q.itemName]=t,a=q.viewMapper(e,i),i[q.itemName]=void 0,n=q.viewMapper(e,i),a!==n?a:t)})}}]).directive("uibTypeahead",function(){return{controller:"UibTypeaheadController",require:["ngModel","^?ngModelOptions","uibTypeahead"],link:function(e,t,a,n){n[2].init(n[0],n[1])}}}).directive("uibTypeaheadPopup",function(){return{scope:{matches:"=",query:"=",active:"=",position:"&",moveInProgress:"=",select:"&"},replace:!0,templateUrl:function(e,t){return t.popupTemplateUrl||"template/typeahead/typeahead-popup.html"},link:function(e,t,a){e.templateUrl=a.templateUrl,e.isOpen=function(){return e.matches.length>0},e.isActive=function(t){return e.active==t},e.selectActive=function(t){e.active=t},e.selectMatch=function(t){e.select({activeIdx:t})}}}}).directive("uibTypeaheadMatch",["$templateRequest","$compile","$parse",function(e,t,a){return{scope:{index:"=",match:"=",query:"="},link:function(n,i,r){var o=a(r.templateUrl)(n.$parent)||"template/typeahead/typeahead-match.html";e(o).then(function(e){t(e.trim())(n,function(e){i.replaceWith(e)})})}}}]).filter("uibTypeaheadHighlight",["$sce","$injector","$log",function(e,t,a){function n(e){return e.replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1")}function i(e){return/<.*>/g.test(e)}var r;return r=t.has("$sanitize"),function(t,o){return!r&&i(t)&&a.warn("Unsafe use of typeahead please use ngSanitize"),t=o?(""+t).replace(new RegExp(n(o),"gi"),"<strong>$&</strong>"):t,r||(t=e.trustAsHtml(t)),t}}]),angular.module("ui.bootstrap.typeahead").value("$typeaheadSuppressWarning",!1).service("typeaheadParser",["$parse","uibTypeaheadParser","$log","$typeaheadSuppressWarning",function(e,t,a,n){return n||a.warn("typeaheadParser is now deprecated. Use uibTypeaheadParser instead."),t}]).directive("typeahead",["$compile","$parse","$q","$timeout","$document","$window","$rootScope","$uibPosition","typeaheadParser","$log","$typeaheadSuppressWarning",function(e,t,a,n,i,r,o,l,s,p,c){var u=[9,13,27,38,40],d=200;return{require:["ngModel","^?ngModelOptions"],link:function(g,h,f,m){function $(){z.moveInProgress||(z.moveInProgress=!0,z.$digest()),X&&n.cancel(X),X=n(function(){z.matches.length&&v(),z.moveInProgress=!1},d)}function v(){z.position=L?l.offset(h):l.position(h),z.position.top+=h.prop("offsetHeight")}c||p.warn("typeahead is now deprecated. Use uib-typeahead instead.");var y=m[0],b=m[1],P=g.$eval(f.typeaheadMinLength);P||0===P||(P=1);var x,w,T=g.$eval(f.typeaheadWaitMs)||0,I=g.$eval(f.typeaheadEditable)!==!1,M=t(f.typeaheadLoading).assign||angular.noop,U=t(f.typeaheadOnSelect),S=angular.isDefined(f.typeaheadSelectOnBlur)?g.$eval(f.typeaheadSelectOnBlur):!1,k=t(f.typeaheadNoResults).assign||angular.noop,D=f.typeaheadInputFormatter?t(f.typeaheadInputFormatter):void 0,L=f.typeaheadAppendToBody?g.$eval(f.typeaheadAppendToBody):!1,C=f.typeaheadAppendToElementId||!1,V=g.$eval(f.typeaheadFocusFirst)!==!1,A=f.typeaheadSelectOnExact?g.$eval(f.typeaheadSelectOnExact):!1,q=t(f.ngModel),E=t(f.ngModel+"($$$p)"),O=function(e,t){return angular.isFunction(q(g))&&b&&b.$options&&b.$options.getterSetter?E(e,{$$$p:t}):q.assign(e,t)},W=s.parse(f.typeahead),z=g.$new(),N=g.$on("$destroy",function(){z.$destroy()});z.$on("$destroy",N);var F="typeahead-"+z.$id+"-"+Math.floor(1e4*Math.random());h.attr({"aria-autocomplete":"list","aria-expanded":!1,"aria-owns":F});var B=angular.element("<div typeahead-popup></div>");B.attr({id:F,matches:"matches",active:"activeIdx",select:"select(activeIdx)","move-in-progress":"moveInProgress",query:"query",position:"position"}),angular.isDefined(f.typeaheadTemplateUrl)&&B.attr("template-url",f.typeaheadTemplateUrl),angular.isDefined(f.typeaheadPopupTemplateUrl)&&B.attr("popup-template-url",f.typeaheadPopupTemplateUrl);var H=function(){z.matches=[],z.activeIdx=-1,h.attr("aria-expanded",!1)},R=function(e){return F+"-option-"+e};z.$watch("activeIdx",function(e){0>e?h.removeAttr("aria-activedescendant"):h.attr("aria-activedescendant",R(e))});var _=function(e,t){return z.matches.length>t&&e?e.toUpperCase()===z.matches[t].label.toUpperCase():!1},j=function(e){var t={$viewValue:e};M(g,!0),k(g,!1),a.when(W.source(g,t)).then(function(a){var n=e===y.$viewValue;if(n&&x)if(a&&a.length>0){z.activeIdx=V?0:-1,k(g,!1),z.matches.length=0;for(var i=0;i<a.length;i++)t[W.itemName]=a[i],z.matches.push({id:R(i),label:W.viewMapper(z,t),model:a[i]});z.query=e,v(),h.attr("aria-expanded",!0),A&&1===z.matches.length&&_(e,0)&&z.select(0)}else H(),k(g,!0);n&&M(g,!1)},function(){H(),M(g,!1),k(g,!0)})};L&&(angular.element(r).bind("resize",$),i.find("body").bind("scroll",$));var X;z.moveInProgress=!1,H(),z.query=void 0;var Y,G=function(e){Y=n(function(){j(e)},T)},J=function(){Y&&n.cancel(Y)};y.$parsers.unshift(function(e){return x=!0,0===P||e&&e.length>=P?T>0?(J(),G(e)):j(e):(M(g,!1),J(),H()),I?e:e?void y.$setValidity("editable",!1):(y.$setValidity("editable",!0),null)}),y.$formatters.push(function(e){var t,a,n={};return I||y.$setValidity("editable",!0),D?(n.$model=e,D(g,n)):(n[W.itemName]=e,t=W.viewMapper(g,n),n[W.itemName]=void 0,a=W.viewMapper(g,n),t!==a?t:e)}),z.select=function(e){var t,a,i={};w=!0,i[W.itemName]=a=z.matches[e].model,t=W.modelMapper(g,i),O(g,t),y.$setValidity("editable",!0),y.$setValidity("parse",!0),U(g,{$item:a,$model:t,$label:W.viewMapper(g,i)}),H(),z.$eval(f.typeaheadFocusOnSelect)!==!1&&n(function(){h[0].focus()},0,!1)},h.bind("keydown",function(e){if(0!==z.matches.length&&-1!==u.indexOf(e.which)){if(-1===z.activeIdx&&(9===e.which||13===e.which))return H(),void z.$digest();e.preventDefault(),40===e.which?(z.activeIdx=(z.activeIdx+1)%z.matches.length,z.$digest()):38===e.which?(z.activeIdx=(z.activeIdx>0?z.activeIdx:z.matches.length)-1,z.$digest()):13===e.which||9===e.which?z.$apply(function(){z.select(z.activeIdx)}):27===e.which&&(e.stopPropagation(),H(),z.$digest())}}),h.bind("blur",function(){S&&z.matches.length&&-1!==z.activeIdx&&!w&&(w=!0,z.$apply(function(){z.select(z.activeIdx)})),x=!1,w=!1});var K=function(e){h[0]!==e.target&&3!==e.which&&0!==z.matches.length&&(H(),o.$$phase||z.$digest())};i.bind("click",K),g.$on("$destroy",function(){i.unbind("click",K),(L||C)&&Q.remove(),L&&(angular.element(r).unbind("resize",$),i.find("body").unbind("scroll",$)),B.remove()});var Q=e(B)(z);L?i.find("body").append(Q):C!==!1?angular.element(i[0].getElementById(C)).append(Q):h.after(Q)}}}]).directive("typeaheadPopup",["$typeaheadSuppressWarning","$log",function(e,t){return{scope:{matches:"=",query:"=",active:"=",position:"&",moveInProgress:"=",select:"&"},replace:!0,templateUrl:function(e,t){return t.popupTemplateUrl||"template/typeahead/typeahead-popup.html"},link:function(a,n,i){e||t.warn("typeahead-popup is now deprecated. Use uib-typeahead-popup instead."),a.templateUrl=i.templateUrl,a.isOpen=function(){return a.matches.length>0},a.isActive=function(e){return a.active==e},a.selectActive=function(e){a.active=e},a.selectMatch=function(e){a.select({activeIdx:e})}}}}]).directive("typeaheadMatch",["$templateRequest","$compile","$parse","$typeaheadSuppressWarning","$log",function(e,t,a,n,i){return{restrict:"EA",scope:{index:"=",match:"=",query:"="},link:function(r,o,l){n||i.warn("typeahead-match is now deprecated. Use uib-typeahead-match instead.");var s=a(l.templateUrl)(r.$parent)||"template/typeahead/typeahead-match.html";e(s).then(function(e){t(e.trim())(r,function(e){o.replaceWith(e)})})}}}]).filter("typeaheadHighlight",["$sce","$injector","$log","$typeaheadSuppressWarning",function(e,t,a,n){function i(e){return e.replace(/([.?*+^$[\]\\(){}|-])/g,"\\$1")}function r(e){return/<.*>/g.test(e)}var o;return o=t.has("$sanitize"),function(t,l){return n||a.warn("typeaheadHighlight is now deprecated. Use uibTypeaheadHighlight instead."),!o&&r(t)&&a.warn("Unsafe use of typeahead please use ngSanitize"),t=l?(""+t).replace(new RegExp(i(l),"gi"),"<strong>$&</strong>"):t,o||(t=e.trustAsHtml(t)),t}}]),angular.module("ui.bootstrap.position",[]).factory("$uibPosition",["$document","$window",function(e,t){function a(e,a){return e.currentStyle?e.currentStyle[a]:t.getComputedStyle?t.getComputedStyle(e)[a]:e.style[a]}function n(e){return"static"===(a(e,"position")||"static")}var i=function(t){for(var a=e[0],i=t.offsetParent||a;i&&i!==a&&n(i);)i=i.offsetParent;return i||a};return{position:function(t){var a=this.offset(t),n={top:0,left:0},r=i(t[0]);r!=e[0]&&(n=this.offset(angular.element(r)),n.top+=r.clientTop-r.scrollTop,n.left+=r.clientLeft-r.scrollLeft);var o=t[0].getBoundingClientRect();return{width:o.width||t.prop("offsetWidth"),height:o.height||t.prop("offsetHeight"),top:a.top-n.top,left:a.left-n.left}},offset:function(a){var n=a[0].getBoundingClientRect();return{width:n.width||a.prop("offsetWidth"),height:n.height||a.prop("offsetHeight"),top:n.top+(t.pageYOffset||e[0].documentElement.scrollTop),left:n.left+(t.pageXOffset||e[0].documentElement.scrollLeft)}},positionElements:function(e,t,a,n){var i,r,o,l,s=a.split("-"),p=s[0],c=s[1]||"center";i=n?this.offset(e):this.position(e),r=t.prop("offsetWidth"),o=t.prop("offsetHeight");var u={center:function(){return i.left+i.width/2-r/2},left:function(){return i.left},right:function(){return i.left+i.width}},d={center:function(){return i.top+i.height/2-o/2},top:function(){return i.top},bottom:function(){return i.top+i.height}};switch(p){case"right":l={top:d[c](),left:u[p]()};break;case"left":l={top:d[c](),left:i.left-r};break;case"bottom":l={top:d[p](),left:u[c]()};break;default:l={top:i.top-o,left:u[c]()}}return l}}}]),angular.module("ui.bootstrap.position").value("$positionSuppressWarning",!1).service("$position",["$log","$positionSuppressWarning","$uibPosition",function(e,t,a){t||e.warn("$position is now deprecated. Use $uibPosition instead."),angular.extend(this,a)}]),angular.module("template/pagination/pager.html",[]).run(["$templateCache",function(e){e.put("template/pagination/pager.html",'<ul class="pager">\n  <li ng-class="{disabled: noPrevious()||ngDisabled, previous: align}"><a href ng-click="selectPage(page - 1, $event)">{{::getText(\'previous\')}}</a></li>\n  <li ng-class="{disabled: noNext()||ngDisabled, next: align}"><a href ng-click="selectPage(page + 1, $event)">{{::getText(\'next\')}}</a></li>\n</ul>\n')}]),angular.module("template/pagination/pagination.html",[]).run(["$templateCache",function(e){e.put("template/pagination/pagination.html",'<ul class="pagination">\n  <li ng-if="::boundaryLinks" ng-class="{disabled: noPrevious()||ngDisabled}" class="pagination-first"><a href ng-click="selectPage(1, $event)">{{::getText(\'first\')}}</a></li>\n  <li ng-if="::directionLinks" ng-class="{disabled: noPrevious()||ngDisabled}" class="pagination-prev"><a href ng-click="selectPage(page - 1, $event)">{{::getText(\'previous\')}}</a></li>\n  <li ng-repeat="page in pages track by $index" ng-class="{active: page.active,disabled: ngDisabled&&!page.active}" class="pagination-page"><a href ng-click="selectPage(page.number, $event)">{{page.text}}</a></li>\n  <li ng-if="::directionLinks" ng-class="{disabled: noNext()||ngDisabled}" class="pagination-next"><a href ng-click="selectPage(page + 1, $event)">{{::getText(\'next\')}}</a></li>\n  <li ng-if="::boundaryLinks" ng-class="{disabled: noNext()||ngDisabled}" class="pagination-last"><a href ng-click="selectPage(totalPages, $event)">{{::getText(\'last\')}}</a></li>\n</ul>\n')}]),angular.module("template/typeahead/typeahead-match.html",[]).run(["$templateCache",function(e){e.put("template/typeahead/typeahead-match.html",'<a href tabindex="-1" ng-bind-html="match.label | uibTypeaheadHighlight:query"></a>\n')}]),angular.module("template/typeahead/typeahead-popup.html",[]).run(["$templateCache",function(e){e.put("template/typeahead/typeahead-popup.html",'<ul class="dropdown-menu" ng-show="isOpen() && !moveInProgress" ng-style="{top: position().top+\'px\', left: position().left+\'px\'}" style="display: block;" role="listbox" aria-hidden="{{!isOpen()}}">\n    <li ng-repeat="match in matches track by $index" ng-class="{active: isActive($index) }" ng-mouseenter="selectActive($index)" ng-click="selectMatch($index)" role="option" id="{{::match.id}}">\n        <div uib-typeahead-match index="$index" match="match" query="query" template-url="templateUrl"></div>\n    </li>\n</ul>\n')}]);
