...
def connections_and_likes(string) :
    ...
    while True :
        ...
        aux_users = string[0: string.find(" ")]
        ...
        while True :
            ...
            if find_point3 == - 1 :
                ...
                break
            aux_users = aux_users[0: string.find(" ")]
            if aux_users not in lista3 :
                lista3.append(aux_users)
...
lista, lista2, lista3 = connections_and_likes(example_input)
